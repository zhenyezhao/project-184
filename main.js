...
const data = {
	...
	Flowers: [
		...
		{ id: 'flower-pic3', src: require('../flower-pic3.png') },
	],
	Hairs: [{ id: 'hair-pic1', src: require('../hair-pic1.png') }],
	Hats: [
		{ id: 'hat-pic1', src: require('../hat-pic1.png') },
		{ id: 'hat-pic2', src: require('../hat-pic2.png') },
	],
	Others: [
		{ id: 'other-pic1', src: require('../other-pic1.png') },
		{ id: 'other-pic2', src: require('../other-pic2.png') },
		{ id: 'other-pic3', src: require('../other-pic3.png') },
	],
};

const filters = {
	'crown-pic1': {
		src: require('../crown-pic1.png'),
		width: 3.5,
		height: 0.7,
		left: 0.46,
		right: 0.15,
